"""
Django settings for misty_mud_39340 project.
...
ROOT_URLCONF = 'misty_mud_39340.urls'
...
WSGI_APPLICATION = 'misty_mud_39340.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_mud_39340 API",
    "DESCRIPTION": "API documentation for misty_mud_39340 App",
    "VERSION": "v1",
}
